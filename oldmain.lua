...
function ThreeDimentional(ps, held, hovered, mx, my)
	ps:cube(0, 1.7, -1, .5, (held and mx or 0), 0, 1, 0, 'line')
end
...
function lovr.draw( pass )
	...
	UI2D.Begin( "Very good", 800, 50 )
	UI2D.Label( "3d" )
	gamesize = {250,150}
	local ps, clicked, held, released, hovered, mx, my, wheelx, wheely = UI2D.CustomWidget( "widget1", gamesize[1], gamesize[2] )
